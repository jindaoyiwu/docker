> 本环境参考以下github项目, 集成大量php扩展内置包和其他配置等环境调整
```
$ docker-compose up                             # 创建并且启动所有容器
$ docker-compose up -d                          # 创建并且后台运行方式启动所有容器
$ docker-compose up nginx php70 mysql57         # 创建并且启动nginx、php、mysql的多个容器
$ docker-compose up -d nginx php70 mysql57      # 创建并且已后台运行的方式启动nginx、php、mysql容器
```
...
- [8.常见问题](#8常见问题)
    ...
    - [8.5 docker容器访问宿主机方式](#85-docker容器访问宿主机方式)
